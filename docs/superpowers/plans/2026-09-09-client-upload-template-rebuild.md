...
=LET(
  src,     FILTER('Add movies'!A2:J, 'Add movies'!A2:A<>""),
  n,       ROWS(src),
  title,   INDEX(src,,1),
  fmt,     INDEX(src,,2),
  typ,     INDEX(src,,3),
  ...
  body,    HSTACK(handle, title, descr, fmt, konst("Media > Videos"), tags, konst("Active"), konst("Genre"), g1, konst("shopify"), konst("1"), konst("deny"), konst("manual"), priceo, img, alt, genres),
